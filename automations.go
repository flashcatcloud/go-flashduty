...
// Fire Automation HTTP POST trigger.
//
// Trigger an Automation run through its HTTP POST trigger URL.
//
// API: POST /safari/automation/triggers/{trigger_id}/fire (automation-trigger-write-fire).
func (s *AutomationsService) TriggerWriteFire(ctx context.Context, req *AutomationFireAPITriggerRequest) (*Response, error) {
	return s.client.do(ctx, "/safari/automation/triggers/{trigger_id}/fire", req, nil)
}
