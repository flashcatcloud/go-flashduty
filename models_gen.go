...
type DiagnoseLogPatternResult struct {
	...
	BaselineWindow DiagnoseEvidenceWindow `json:"baseline_window" toon:"baseline_window"`
...
type LogPatternDiagnoseSummary struct {
	...
	BaselineSample LogPatternSampleSummary `json:"baseline_sample" toon:"baseline_sample"`
	...
	PatternsAggregatedOnlyInBaselineSample int64 `json:"patterns_aggregated_only_in_baseline_sample" toon:"patterns_aggregated_only_in_baseline_sample"`
}
...
type LogPatternEvidence struct {
	...
	BaselineWindow LogPatternWindowEvidence `json:"baseline_window" toon:"baseline_window"`
	// Observed comparability between the current and baseline windows.
	ComparisonStatus string `json:"comparison_status" toon:"comparison_status"`
	// Evidence for this pattern in the current window.
	CurrentWindow LogPatternWindowEvidence `json:"current_window" toon:"current_window"`
	...
	RedactedLogExamples []string `json:"redacted_log_examples" toon:"redacted_log_examples"`
}
...
type LogPatternSampleSummary struct {
	...
	SamplingBias string `json:"sampling_bias" toon:"sampling_bias"`
...
type LogPatternWindowEvidence struct {
	...
	ObservedSeverityCounts map[string]int64 `json:"observed_severity_counts" toon:"observed_severity_counts"`
	...
	Sources []LogPatternSourceEvidence `json:"sources" toon:"sources"`
}
...
type MetricTrendSeriesEvidence struct {
	...
	BaselineWindowStats MetricTrendWindowStats `json:"baseline_window_stats" toon:"baseline_window_stats"`
	...
	CurrentWindowStats MetricTrendWindowStats `json:"current_window_stats" toon:"current_window_stats"`
